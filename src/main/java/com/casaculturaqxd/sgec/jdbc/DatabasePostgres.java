...
public class DatabasePostgres implements Database {
    ...
    /**
     * cria uma nova instancia com as chaves especificadas ou substitui a instancia atual por outra
     */
    ...
    /**
     * cria a instancia padrao
     */
    public static DatabasePostgres getInstance() {
        try {
            if (instance == null || instance.getConnection().isClosed()) {
                instance = new DatabasePostgres("URL", "USER_NAME", "PASSWORD");
            }
            return instance;
